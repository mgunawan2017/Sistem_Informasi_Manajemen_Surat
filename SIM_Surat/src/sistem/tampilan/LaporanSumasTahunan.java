 ...
 * @author compaq
 */
public class LaporanSumasTahunan extends javax.swing.JFrame {

    /**
     * Creates new form LaporanSumasTahunan
     */
    public LaporanSumasTahunan() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("LAPORAN SURAT MASUK TAHUNAN");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
                    String NamaFile = "src/sistem/tampilan/laporanSumasTahunan.jasper"; //Lokasi File jasper
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaporanSumasTahunan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LaporanSumasTahunan().setVisible(true);
            }
        });
    }
