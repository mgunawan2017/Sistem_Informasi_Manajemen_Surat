 ...
 * @author compaq
 */
public class LaporanSukelTahunan extends javax.swing.JFrame {

    /**
     * Creates new form LaporanSumasTahunan
     */
    public LaporanSukelTahunan() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("LAPORAN SURAT KELUAR TAHUNAN");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
                    String NamaFile = "src/sistem/tampilan/laporanSukelTahunan.jasper"; //Lokasi File jasper
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaporanSukelTahunan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LaporanSukelTahunan().setVisible(true);
            }
        });
    }
